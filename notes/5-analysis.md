...
The instability restores the flow to a stable state, with $\text{Ri}_b = 1$, and vertically mixes the passive tracer in the process. In addition, the sudden impact of the instability kicks off oscillations, which show up in the bulk Richardson number. 
