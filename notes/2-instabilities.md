...
> 
> B. Show that under this approximation, a plane-wave mode $(u, v, w, b) = (\hat u, \hat v, \hat w, \hat b)\exp[\text i(kx + mz - \omega t)]$ evolving in an infinitely long domain follows the dispersion relationship
> 
